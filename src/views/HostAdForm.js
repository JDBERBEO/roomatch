...
function HostAdForm() {
  ...
  } = useSelector(({ hostPostReducerReducer }) => {
    return {
          ...
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group controlId="private_bathroom">
              ...
              <Form.Control
                ...
                name="n"
                onChange={(e) => dispatch(changePrivateBathRoom(e.target.value))}
            ...
            <Form.Group controlId="activities">
              ...
              <Form.Control
                ...
                name="activities"
                onChange={(e) => dispatch(changeActivities(e.target.value))}
                value={activities}
              />
            </Form.Group>
            <Form.Group controlId="ranking">
              ...
              <Form.Control
                ...
                name="ranking"
                onChange={(e) =>
                  dispatch(changeRanking(e.target.value))
                }
                value={ranking}
              />
            </Form.Group>
